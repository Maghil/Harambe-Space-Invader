...
public class HarambeBullet : MonoBehaviour
{
    private Transform bullet;
    public float speed=0.09f;    //good speed for harambe
    public int direction=1;   //specify the direction to shoot 1->up 2->down 3-> downRight 4->downLeft
    ...
    {   
        ...
        {
            FindObjectOfType<LevelManager>().EnemyScore();
            Destroy(other.gameObject);
            Destroy(gameObject);
        }
    }
